...
/*   Updated: 2026/05/14 20:00:57 by aelbouaz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\033[1;32mCostum Constructor Called!\033[0m" << std::endl;
	this->name = name;
}

ClapTrap::~ClapTrap()
{
	std::cout << "\033[1;31mDestructor for " << this->name <<" Called!\033[0m" << std::endl;
}
